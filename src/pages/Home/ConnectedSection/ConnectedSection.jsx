const ConnectedSection = () => {
    return (
        <div className="backdrop-blur-3xl w-11/12 mx-auto md:mx-auto p-px rounded-2xl bg-gradient-to-r from-purple-600/20 to-blue-500/30">
            <div className="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px] bg-gradient-to-r from-[#ece4a0] to-[#fbe87d]">
                ...
                <h2 className="text-2xl md:text-4xl font-medium mt-2">
                    ...
                    <span className="bg-gradient-to-r from-gray-300 to-gray-900 bg-clip-text text-transparent">Expert Guidance </span>
                    & Proven Results!
                </h2>
                ...
                <button type="button" className="bg-gradient-to-r from-yellow-500 to-yellow-500 text-black text-sm px-5 py-2.5 rounded-xl font-medium mt-4 hover:scale-105 active:scale-95 transition-all duration-300">
                    Get Started Today
                </button>
            </div>
        </div>
