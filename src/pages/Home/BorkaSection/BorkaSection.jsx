import borka1 from "../../../assets/images/BorkaSection/borka1.jpg"
import borka2 from "../../../assets/images/BorkaSection/borka2.jpg"
import borka3 from "../../../assets/images/BorkaSection/borka3.jpg"
      ...
      <div className="flex flex-col md:flex-row gap-5">
        ...
        <div className="relative h-[420px] md:h-[500px] overflow-hidden rounded-lg">
          ...
          <div className="absolute top-8 left-6 text-white">
            <p className="tracking-[0.4rem] text-xs">PARTY</p>
            <h2 className="text-4xl font-extrabold">ABAYA</h2>
          </div>
        </div>
